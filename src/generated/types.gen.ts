...
export type ClaimStatusType = 'claimed' | 'rejected' | 'succeeded';
...
export type $type3 = 'comfyVideoGen';
...
export type $type7 = 'llmPromptAugmentation';
...
export type $type12 = 'textToImageV2';

export const $type12 = {
  TEXT_TO_IMAGE_V2: 'textToImageV2',
} as const;
...
export type UploadBlobResponse = unknown;

export type UploadBlobError = ProblemDetails;
...
export type ClaimJobsResponse = Array<Claim>;

export type ClaimJobsError = ProblemDetails;
...
export type UpdateClaimStatusResponse = void;

export type UpdateClaimStatusError = ProblemDetails;
...
export type GetRecommendedResourcesResponse = Array<ResourceInfo>;

export type GetRecommendedResourcesError = ProblemDetails;
...
export type $OpenApiTs = {
  ...
  '/v2/providers/workers/{workerId}/claims/{claimId}/status': {
    put: {
      req: UpdateClaimStatusData;
      res: {
        /**
         * No Content
         */
  ...
  '/v2/providers/workers/{workerId}/resources': {
    get: {
      req: GetRecommendedResourcesData;
      res: {
        /**
         * OK
         */
