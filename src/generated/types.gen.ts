...
export type ImageResourceTrainingStep = WorkflowStep & {
   ...
   */
  input: KohyaImageResourceTrainingInput | FluxDevFastImageResourceTrainingInput;
...
export type ImageResourceTrainingStepTemplate = WorkflowStepTemplate & {
  /**
   * Input for the ImageResourceTrainingStep step.
   */
  input: KohyaImageResourceTrainingInput | FluxDevFastImageResourceTrainingInput | null;
} & {
  $type: 'imageResourceTraining';
};
...
export type VideoGenStep = WorkflowStep & {
   ...
   */
  output?: HaiperVideoGenOutput | null;
} & {
  $type: 'videoGen';
};
...
export type VideoGenStepTemplate = WorkflowStepTemplate & {
  /**
   * Input for the VideoGenStep step.
   */
  input:
    | HaiperVideoGenInput
    | MochiVideoGenInput
...
export type InvokeImageResourceTrainingStepTemplateData = {
  body?: KohyaImageResourceTrainingInput | FluxDevFastImageResourceTrainingInput;
};
...
export type GetJobsResponse = Array<
  | TextToImageJob
